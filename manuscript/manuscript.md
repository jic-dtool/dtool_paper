...
group devise a protocol for marking up raw sequencing data as it arrived from
the sequencing company.

To date 26TiB of data has been marked up as 803 datasets.
...
dtool has provided substantial benefits for the groups that have started using it.
...
different storage systems to which we have access has substantially reduced
